...
class MagmoorCavernsAreaData(AreaData):
    rooms = {
        ...
        RoomName.Fiery_Shores: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Fiery Shores - Morph Track', required_items=[], tricks=[]), PickupData('Magmoor Caverns: Fiery Shores - Warrior Shrine Tunnel', required_items=[], tricks=[]), ]),
        RoomName.Geothermal_Core: RoomData(doors={}, pickups=[]),
        RoomName.Lake_Tunnel: RoomData(doors={}, pickups=[]),
        RoomName.Lava_Lake: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Lava Lake', required_items=[], tricks=[]), ]),
        RoomName.Magmoor_Workstation: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Magmoor Workstation', required_items=[], tricks=[]), ]),
        ...
        RoomName.Plasma_Processing: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Plasma Processing', required_items=[], tricks=[]), ]),
        RoomName.Save_Station_Magmoor_A: RoomData(doors={}, pickups=[]),
        RoomName.Save_Station_Magmoor_B: RoomData(doors={}, pickups=[]),
        RoomName.Shore_Tunnel: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Shore Tunnel', required_items=[], tricks=[]), ]),
        RoomName.South_Core_Tunnel: RoomData(doors={}, pickups=[]),
        RoomName.Storage_Cavern: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Storage Cavern', required_items=[], tricks=[]), ]),
        ...
        RoomName.Transport_Tunnel_A: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Transport Tunnel A', required_items=[], tricks=[]), ]),
        RoomName.Transport_Tunnel_B: RoomData(doors={}, pickups=[]),
        RoomName.Transport_Tunnel_C: RoomData(doors={}, pickups=[]),
        RoomName.Triclops_Pit: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Triclops Pit', required_items=[], tricks=[]), ]),
        RoomName.Twin_Fires_Tunnel: RoomData(doors={}, pickups=[]),
        RoomName.Twin_Fires: RoomData(doors={}, pickups=[]),
        RoomName.Warrior_Shrine: RoomData(doors={}, pickups=[PickupData('Magmoor Caverns: Warrior Shrine', required_items=[], tricks=[]), ]),

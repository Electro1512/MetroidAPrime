    ...
    return BlastShieldArea(
        ...
        regions=[
            BlastShieldRegion(
                ...
                invalid_start_rooms=[RoomName.Warrior_Shrine, RoomName.Transport_to_Chozo_Ruins_East, RoomName.Arbor_Chamber, RoomName.Landing_Site]
            ),
            BlastShieldRegion(
    ...
    return BlastShieldArea(
        ...
        regions=[
            ...
            BlastShieldRegion(
                ...
                invalid_start_rooms=[RoomName.Arbor_Chamber, RoomName.Transport_to_Chozo_Ruins_East, RoomName.Landing_Site]
            ),
            BlastShieldRegion(
            ...
            BlastShieldRegion(
                ...
                invalid_start_rooms=[RoomName.Transport_to_Chozo_Ruins_East, RoomName.Landing_Site]
            ),
            BlastShieldRegion(
                ...
                invalid_start_rooms=[RoomName.Warrior_Shrine, RoomName.Arbor_Chamber, RoomName.Transport_to_Chozo_Ruins_East, RoomName.Landing_Site]
            ),
            BlastShieldRegion(

...
def construct_hud_message_patch(game_version: str) -> List[int]:
    from .lib.ppc_asm.assembler.ppc import addi, bl, li, lwz, r1, r3, r4, r5, r6, r31, stw, cmpwi, bne, mtspr, blr, lmw, r0, LR, stwu, mfspr, or_, lbz, stmw, stb, lis, r7, r9, nop, ori, GeneralRegister
    from .lib.ppc_asm import assembler
